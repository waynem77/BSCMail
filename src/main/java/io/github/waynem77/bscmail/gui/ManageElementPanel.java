...
public abstract class ManageElementPanel<E> extends JPanel {
    ...
    /**
     * Enables or disables editing on the controls in the panel.
     *
     * @param enabled true to enable editing; false to disable editing
     * @since 4.0
     */
    ...
    /**
     * Creates and returns a copy of this panel.
     * @return a copy of this panel
     * @since 4.0
     */
    public abstract ManageElementPanel<E> createCopy();

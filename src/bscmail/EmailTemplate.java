...
public class EmailTemplate implements Cloneable, Serializable, ReadWritable {
    ...
    public static class Factory implements ReadWritableFactory<EmailTemplate> {
         ...
         * value does not exist or is null, the manager's name is empty.</li>
        ...
        public EmailTemplate constructReadWritable(Map<String, Object> properties) {
            ...
            return new EmailTemplate(preScheduleText, postScheduleText);
     ...
     * <ul>
     *   <li>The map has exactly two keys: "preScheduleText" and
     * "postScheduleText".</li>
    ...
    public boolean equals(Object obj) {
        ...
        return preScheduleText.equals(rhs.preScheduleText) && postScheduleText.equals(rhs.postScheduleText);
    }    // equals()
